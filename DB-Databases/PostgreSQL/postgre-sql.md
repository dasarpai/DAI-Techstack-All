...
## Download:
- source: edb: https://www.enterprisedb.com/
- https://www.enterprisedb.com/downloads/postgres-postgresql-downloads
- EDB BigAnimal Fully Managed Database-as-a-Service
...
pwd: postgres 
port: 5432
local to be used by new database - [Default locale]
...
Installation Log: C:\Users\hari_\AppData\Local\Temp\install-postgresql.log

Documentation: Postgressql documentation.

Stack Builder:
Used to download, install additional tools, drivers, and applications to complete postgre installation.
